...
class FindingUIObjectsTutorial(Tutorial):
    def __init__(self):
        ...
        self.add_step(TutorialStep("Highlighting UI Objects", 
                ...
                when the parent has multiple unnamed children of the same type.</li></ul></p></html>"""))
        ...
        self.add_step(TutorialStep("Highlight by pattern", """<html><p style="font-size:13px">This step highlights 
                ...
                type, <strong><code style="font-size:14px;color:#E44C9A">{"text": "button", "type": 
                QtWidgets.QToolButton}</code></strong>. </p></html>""", {"text": "button", 
                "type": QtWidgets.QToolButton}))
        self.add_step(TutorialStep("Highlight by pattern", """<html><p style="font-size:13px">This step 
                ...
                element by providing the widget type and the tooltip text, <strong><code style="font-size:14px;
                color:#E44C9A">{"type": QtWidgets.QToolButton, "text": "Play Game"}</code></strong>.</p></html>""", 
                {"type": QtWidgets.QToolButton, "text": "Play Game"}))
        self.add_step(TutorialStep("Highlight from named parent", """<html><p style="font-size:13px">This step highlights 
                the <b>Transform Toolbar</b> in the upper-left corner of the viewport. The Transform Toolbar widget is 
                unnamed and has no tooltip text. We can find it by its type through its named parent. It's the first 
                child of type <strong><code style="font-size:14px;color:#E44C9A">QtWidgets.QToolBar</code></strong> of a 
                widget named <strong><code style="font-size:14px;color:#E44C9A">"ViewportUiOverlay"</code></strong>.
                </p></html>""", QtWidgets.QToolBar, "ViewportUiOverlay"))
        self.add_step(TutorialStep("Highlight from named parent with index", """<html><p style="font-size:13px">In 
                the upper-right corner of the viewport is the <b>Transform Space Toolbar</b>. It is an unnamed widget 
                of type <strong><code style="font-size:14px;color:#E44C9A">QtWidgets.QToolBar</code></strong>. It's also
                 the second child of the <strong><code style="font-size:14px;color:#E44C9A">"ViewportUiOverlay"</code>
                </strong> widget we referenced in the previous step. To highlight the Transform Space Toolbar, we use 
                the same method as the previous step, but provide an optional index value of <strong>
                <code style="font-size:14px;color:#E44C9A">1</code></strong> to select the second child.</p></html>""", 
        ...
        self.add_step(TutorialStep("Highlight from named parent with index - advanced", """<html><p style="font-size:13px">
                What if you want to highlight a UI element, but its nearest named parent is a couple of levels and 
                indices away?<br><br>
                The Transform Space Toolbar has three buttons: <b>W</b>orld, <b>P</b>arent, and <b>L</b>ocal space. Suppose we want to 
                highlight the Local space button. It's the fourth <strong><code style="font-size:14px;color:#E44C9A">
                QtWidgets.QToolButton</code></strong> in the second <strong><code style="font-size:14px;color:#E44C9A">
                QtWidgets.QToolBar</code></strong> beneath a parent named <strong>
                <code style="font-size:14px;color:#E44C9A">ViewportUiOverlay</code></strong>.<br><br>
