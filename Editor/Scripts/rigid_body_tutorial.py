...
class RigidBodyTutorial(Tutorial):
    def __init__(self):
        ...
        self.add_step(TutorialStep("Dynamic Simulation with PhysX Rigid Bodies", 
                ...
                for the ground plane, and simulate the results.<br><br>Click next to continue.</p></html>"""))
        ...
        self.add_step(TutorialStep("Inspect the dice entity", """<html><p style="font-size:13px"><b>Entity 
                ...
                entity.</li><li><b>Material</b> - Applies shaders and textures to the render mesh.</il></ul>In the next 
                steps we'll add and configure components in Entity Inspector.<br><br><br>Step 8 of 20</p></html>""", 
                "InspectorMainWindow"))
        self.add_step(TutorialStep("Add a PhysX Collider", """<html><p style="font-size:13px">A collider is a simplified
                ...
                click the <b>Add Component</b> button and select the PhysX Collider component from the list to 
        ...
        self.add_step(TutorialStep("Run the simulation", """<html><p style="font-size:13px">We can now run the 
                ...
                the air an spin, then fall and collide with the ground plane. Press <b>ESC</b> to exit.<br><br><br>Step 
                20 of 20</p></html>"""))
