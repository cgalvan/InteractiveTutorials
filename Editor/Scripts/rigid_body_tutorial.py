...
class RigidBodyTutorial(Tutorial):
    def __init__(self):
        ...
        self.add_step(TutorialStep("Delete the Shader Ball entity", """<html><p style="font-size:13px">Tidy up the scene 
        ...
        self.add_step(TutorialStep("Instantiate a prefab", """<html><p style="font-size:13px">To use the prefab in the 
        ...
        self.add_step(TutorialStep("Open the prefab instance in Focus Mode", """<html><p style="font-size:13px">You'll 
                ...
                modifications you make happen in the context of the prefab instance that is open for editing.<br><br><br>
        ...
        self.add_step(TutorialStep("Add an initial linear velocity", """<html><p style="font-size:13px">The <b>PhysX 
                ...
                "InspectorMainWindow"))
        self.add_step(TutorialStep("Add an initial angular velocity", """<html><p style="font-size:13px">You can also 
                ...
                "InspectorMainWindow"))
        self.add_step(TutorialStep("Exit Focus Mode", """<html><p style="font-size:13px">You're done editing the prefab 
        ...
        self.add_step(TutorialStep("Save the prefab", """<html><p style="font-size:13px">In <b>Entity Outliner</b>, 
                ...
                "EntityOutlinerWidgetUI"))
        self.add_step(TutorialStep("Add a ground plane collider", """<html><p style="font-size:13px">You need to add a 
        ...
        self.add_step(TutorialStep("Position the ground collider", """<html><p style="font-size:13px">The ground 
                ...
                "renderOverlay"))
        self.add_step(TutorialStep("Run the simulation", """<html><p style="font-size:13px">You can now run the 
